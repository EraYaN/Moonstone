 ...
 */
public class JPB2JrTachoRobot extends UVMRobot
{
	 ...
	 * @param positionY
	 */
	public JPB2JrTachoRobot(String name, double positionX, double positionY)
	{
		/*
		 * friction = 7.0
		 * diameter = 2.0
		...
		try
		{
			...
			getSensors()[6] = addSensor("TachoSensor", BASE_RADIUS, 60);					// Left
			getSensors()[7] = addSensor("TachoSensor", BASE_RADIUS, 60);					// Right
		}
