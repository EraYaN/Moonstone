...
public class ChaseBallBehavior extends Behavior
{
	...
	public ChaseBallBehavior(BaseController initJoBot, PeriodicTimer initServiceTick,
			int servicePeriod)
	{
	...
	public void doBehavior()
	{
		...
		int sl = joBot.getSensorValue(0); // Get the bumper sensors
		int sr = joBot.getSensorValue(1);
		int bl = joBot.getSensorValue(4); // Get the ball sensors
		int br = joBot.getSensorValue(5);
