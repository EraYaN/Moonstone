...
public class UVMDemo extends UVMRunnable implements AgentWebService,
	...
	private String DIP = "0=Idle ,1=Calib,2=Flee ,3=     ,4=Curiu,5=     ,6=     ,7=Dummy,8=Wall ";
	...
	public void processState(int dipValue) {
		...
		//	Opdracht 8  - Maak reactief gedrag				
			currentBehavior = new CuriousBehavior(joBot, behaviorServiceTick,
					100);
			break;
	...
	public void run() {
		System.out.println("UVMdemo Nano NLT Grid V323");
		try {
