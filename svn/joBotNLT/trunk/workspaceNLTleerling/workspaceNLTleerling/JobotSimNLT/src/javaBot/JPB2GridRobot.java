 ...
 *         the JPB2Robot
 */
public class JPB2GridRobot extends UVMRobot
{
	private static final String	IMAGE_FILE			= Simulator
															.getRelativePath("./resources/jobot.gif");
	private static final String	CONFIG_XML			= Simulator.getRelativePath("./JoBot/Grid/jobot.xml");
	 ...
	 * @param positionY
	 */
	public JPB2GridRobot(String name, double positionX, double positionY)
	{
		/*
		 * friction = 7.0
		 * diameter = 2.0
		...
		try
		{
			...
			getSensors()[6] = addSensor("FieldSensor", BASE_RADIUS, 240);					// Right
		}
