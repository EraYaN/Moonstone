...
public class JoBotNanoNLTTestRobot extends NanoRobot
{
	 ...
	 * @param positionY
	 */
	public JoBotNanoNLTTestRobot(String name, double positionX, double positionY)
	{
		/*
		 * friction = 7.0
		 * diameter = 2.0
		...
		try
		{
			...
			getSensors()[2] = addSensor("DummySensor", 0,0);			                    // Microphone
	...
	public void loadApp(String configXML)
	{
		 ...
		 */
		servoMotors = new JoBotServoMotor[5];
