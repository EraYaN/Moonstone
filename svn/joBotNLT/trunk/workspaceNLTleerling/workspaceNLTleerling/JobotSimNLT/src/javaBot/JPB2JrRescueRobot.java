 ...
 */
public class JPB2JrRescueRobot extends UVMRobot
{
	...
	private static final String	CONFIG_XML			= Simulator
															.getRelativePath("./Junior/Demo/joBotJr.xml");
	private static final int	DIAMETER_IN_IMAGE	= 100;

	public static final double	BASE_RADIUS			= 0.020;
	 ...
	 * @param positionY
	 */
	public JPB2JrRescueRobot(String name, double positionX, double positionY)
	{
		/*
		 * friction = 7.0
		 * diameter = 2.0
