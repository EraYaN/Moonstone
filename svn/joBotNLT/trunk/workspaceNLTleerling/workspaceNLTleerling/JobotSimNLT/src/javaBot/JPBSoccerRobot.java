 ...
 *         the JPB2Robot
 */
public class JPBSoccerRobot extends UVMRobot
{
	private static final String	IMAGE_FILE			= Simulator
															.getRelativePath("./resources/jobot.gif");
	private static final String	CONFIG_XML			= Simulator.getRelativePath("./UVM/Soccer/jobot.xml");
	 ...
	 * @param positionY
	 */
	public JPBSoccerRobot(String name, double positionX, double positionY)
	{
		/*
		 * friction = 7.0
		 * diameter = 2.0
		...
		try
		{
	        ...
	        getSensors()[3] = addSensor("IRSensor", WHEEL_RADIUS, 300, 290);
	        getSensors()[4] = addSensor("IRSensor", WHEEL_RADIUS, 240, 250);
	        getSensors()[5] = addSensor("FieldSensor" , BASE_RADIUS, 270);
		}
