...
public class JoBotNanoNLTToetsRobot extends NanoRobot
{
	...
	private static final String	CONFIG_XML			= Simulator
															.getRelativePath("./Nano/Toets/joBotNano.xml");
	 ...
	 * @param positionY
	 */
	public JoBotNanoNLTToetsRobot(String name, double positionX, double positionY)
	{
		/*
		 * friction = 7.0
		 * diameter = 2.0
