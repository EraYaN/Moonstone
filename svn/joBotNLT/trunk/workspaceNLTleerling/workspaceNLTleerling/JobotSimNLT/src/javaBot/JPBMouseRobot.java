...
/**
 * Adaptated from JPB2MouseBot ver. 0.0 for the 2006 Mouse Sensor project
 * Equips the robot with the DXMouseSensor and DYMouseSensor Sensor classes.
 * 
 ...
 *         2005   Seperated JPB2Robot into implementation of UVMRobot which
 ...
 *         the JPB2Robot
 */
public class JPBMouseRobot extends UVMRobot
{
	private static final String	IMAGE_FILE			= Simulator
															.getRelativePath("./resources/jobot.gif");
	private static final String	CONFIG_XML			= Simulator.getRelativePath("JPB2/jobot.xml");
	 ...
	 * @param positionY
	 */
	public JPBMouseRobot(String name, double positionX, double positionY)
	{
		/*
		 * friction = 7.0
		 * diameter = 2.0
		...
		try
		{
	        ...
	        getSensors()[3] = addSensor("FieldSensor" , BASE_RADIUS, 270);
	        getSensors()[4] = addSensor("IRSensor", WHEEL_RADIUS, 270, 90);
	        getSensors()[5] = addSensor("DXMouseSensor" , BASE_RADIUS, 270);
	        getSensors()[6] = addSensor("DYMouseSensor" , BASE_RADIUS, 270);
		}
