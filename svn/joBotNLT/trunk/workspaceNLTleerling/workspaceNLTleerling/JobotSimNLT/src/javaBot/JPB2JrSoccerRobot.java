 ...
 */
public class JPB2JrSoccerRobot extends UVMRobot
{
	...
	private static final String	CONFIG_XML			= Simulator
															.getRelativePath("./Junior/Soccer/joBotJr.xml");
	 ...
	 * @param positionY
	 */
	public JPB2JrSoccerRobot(String name, double positionX, double positionY)
	{
		/*
		 * friction = 7.0
		 * diameter = 2.0
		...
		try
		{
			...
			getSensors()[2] = addSensor("FieldSensor", BASE_RADIUS, 110);					// Left / Middle
			getSensors()[3] = addSensor("FieldSensor", BASE_RADIUS, 70);					// Right
			getSensors()[4] = addSensor("IRSensor", BASE_RADIUS, 300, 110);					// Left
			getSensors()[5] = addSensor("IRSensor", BASE_RADIUS, 240, 70);					// Right
		}
