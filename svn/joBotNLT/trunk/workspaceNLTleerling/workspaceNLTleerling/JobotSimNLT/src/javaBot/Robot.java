...
public abstract class Robot extends MovableObject implements IDragable
{
	...
	public static final int		MODEL_JOBOT				= 1;
	public static final int		MODEL_JUNIOR			= 2;	
	public static final int		MODEL_NANO				= 3;	
