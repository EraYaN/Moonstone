...
public class JoBotNanoNLTSoccerRobot extends NanoRobot
{
	...
	private static final String	CONFIG_XML			= Simulator
															.getRelativePath("./Nano/Soccer/joBotNano.xml");
	 ...
	 * @param positionY
	 */
	public JoBotNanoNLTSoccerRobot(String name, double positionX, double positionY)
	{
		/*
		 * friction = 7.0
		 * diameter = 2.0
		...
		if (servoMotors != null)
		{
			...
			getActors()[2] = servoMotors[1];
			getActors()[3] = servoMotors[1];
			getActors()[4] = servoMotors[1];
		}
	}
