...
public class JPB2JrNLTTestRobot extends UVMRobot
{
	...
	private static final String	CONFIG_XML			= Simulator
															.getRelativePath("./Junior/Test/joBotJr.xml");
	 ...
	 * @param positionY
	 */
	public JPB2JrNLTTestRobot(String name, double positionX, double positionY)
	{
		/*
		 * friction = 7.0
		 * diameter = 2.0
