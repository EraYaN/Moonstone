...
//		}
		...
		s1 = getJoBot().getSensorValue(9); // 9v
		System.out.print("V1=");
		System.out.print(s1);
		s1 = getJoBot().getSensorValue(8); // 6v
		System.out.print(" V2=");
		System.out.print(s1);
...
//		else
		...
		getJoBot().setLed(BaseController.LED_YELLOW, i == 0 || i == 2); // Show sensor detected
		getJoBot().setLed(BaseController.LED_GREEN, i == 1 || i == 3);
		getJoBot().setLed(BaseController.LED_BLUE, i > 1 || i == 4);
		getJoBot().drive(0, 0);
	}
}
