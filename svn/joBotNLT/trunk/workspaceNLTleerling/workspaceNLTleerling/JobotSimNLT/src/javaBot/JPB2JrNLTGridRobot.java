...
public class JPB2JrNLTGridRobot extends UVMRobot
{
	...
	private static final String	CONFIG_XML			= Simulator
															.getRelativePath("./Junior/Grid/joBotJr.xml");
	 ...
	 * @param positionY
	 */
	public JPB2JrNLTGridRobot(String name, double positionX, double positionY)
	{
		/*
		 * friction = 7.0
		 * diameter = 2.0
