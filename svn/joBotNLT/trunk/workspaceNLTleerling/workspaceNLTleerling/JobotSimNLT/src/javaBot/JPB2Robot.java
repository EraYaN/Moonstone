 ...
 *         the JPB2Robot
 */
public class JPB2Robot extends UVMRobot
{
	 ...
	 * @param positionY
	 */
	public JPB2Robot(String name, double positionX, double positionY)
	{
		/*
		 * friction = 7.0
		 * diameter = 2.0
...
//			getSensors()[5] = addSensor("IRSensor", BASE_RADIUS, 410, 270);					// Left
//			getSensors()[6] = addSensor("IRSensor", BASE_RADIUS, 480, 270);					// Right
		}
