...
public abstract class JobotAgent extends Agent
{
	 ...
	 * 
	 * @param vx
	 *        Speed of the horizontal movement, see vy for movement perspective
	 * @param vy
	 *        Speed of vertical movement. The movement is in perspective of the
	 *        robot. So if the robot has an angle of 45 degrees, and only an y
	 *        movement is given, then the robot will move in the 45degrees
	 *        direction.
	 * @param omega
	 *        Rotation speed and angle of the robot. Positive value will rote to
	...
	public void vectorDrive(double vx, double vy, double omega)
	{
		...
		//a is equal to the jobot's wheel angles
