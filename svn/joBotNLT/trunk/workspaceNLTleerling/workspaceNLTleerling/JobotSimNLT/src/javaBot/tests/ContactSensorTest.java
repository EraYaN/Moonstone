...
public class ContactSensorTest extends TestCase
{
	...
	{
		assertEquals(512, this.cSensor.convertDistanceToValue(0));				
	}
	...
	{
		assertEquals(512, this.cSensor.convertDistanceToValue(0.01));
		assertEquals(512, this.cSensor.convertDistanceToValue(0.1));
	...
	{
		assertEquals(0, this.cSensor.sensorLine(0.0, 0.0, 0.0).getLength(), 0.15000000002);
