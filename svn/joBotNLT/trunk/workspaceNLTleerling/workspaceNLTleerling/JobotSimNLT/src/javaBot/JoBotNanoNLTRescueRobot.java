...
public class JoBotNanoNLTRescueRobot extends NanoRobot
{
	...
	private static final String	CONFIG_XML			= Simulator
															.getRelativePath("./Nano/Rescue/joBotNano.xml");
	 ...
	 * @param positionY
	 */
	public JoBotNanoNLTRescueRobot(String name, double positionX, double positionY)
	{
		/*
		 * friction = 7.0
		 * diameter = 2.0
