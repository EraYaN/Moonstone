 ...
 * 2 - IR sensor left and 
 * 3 - IR sensor right 
 * 4 - Ground sensor middle or 
 * 4 - Ground sensor left and 
 * 5 - Ground sensor right 
...
// ToDo: Include S148 servo processing
...
public class UVMDemo extends UVMRunnable implements AgentWebService, TimerListener
{
	...
	public static final int			STATE_DRIVE			= 4;
	public static final int			STATE_WALL_FOLLOWER	= 4;
	public static final int			STATE_CHASE_BALL	= 4;
	public static final int			STATE_FOLLOW_LINE	= 8;
	...
	public void run()
	{
		System.out.println("Junior Rescue Demo V2.2.1");
