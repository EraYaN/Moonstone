 ...
 *         the JPB2Robot
 */
public class JPB2TestRobot extends UVMRobot
{
	private static final String	IMAGE_FILE			= Simulator
															.getRelativePath("./resources/jobot.gif");
	private static final String	CONFIG_XML			= Simulator.getRelativePath("./JoBot/Test/jobot.xml");
	 ...
	 * @param positionY
	 */
	public JPB2TestRobot(String name, double positionX, double positionY)
	{
		/*
		 * friction = 7.0
		 * diameter = 2.0
