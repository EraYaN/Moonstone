 ...
 *  Ver 1.0 - 12-Oct-2008       Included NanoRobot with LCD support
 *
 * Avatar
 * 
 ...
 */
public abstract class NanoRobot extends UVMRobot implements StepTimeListener, ADCSampleListener,
		DigitalOutputPinListener, AgentWebService
{
	...
	JoBotNanoController			controller;
	 ...
	 */
	public NanoRobot(String name, double friction, double positionX, double positionY,
			double diameter, double mass, int model)
	{
		super(name, friction, positionX, positionY, diameter, mass, model);
	}
	...
	public void lcdChanged(String text) {
		getLCD().setText(text);
	}
	
	public LCDPrinterImpl createLCDHandler() {
		  return new LCDPrinterImpl();
		}
		
		public class LCDPrinterImpl extends LCDPrinter {
			public void println (String print) {
				getLCD().setText(print);
			}
