 ...
 */
public class JPBRescueRobot extends UVMRobot
{
	 ...
	 * @param positionY
	 */
	public JPBRescueRobot(String name, double positionX, double positionY)
	{
		/*
		 * friction = 7.0
		 * diameter = 2.0
		...
		try
		{
	        ...
	        getSensors()[0] = addSensor("ReflectionSensor",BASE_RADIUS, 135);
	        getSensors()[1] = addSensor("ReflectionSensor",BASE_RADIUS, 45);
	        getSensors()[2] = addSensor("FieldSensor",BASE_RADIUS, 135);
	        getSensors()[3] = addSensor("FieldSensor" , BASE_RADIUS, 45);
		}
	...
	public void loadApp(String configXML)
	{
		...
		controller = new JoBotJPBController(this, .1, vbbRTI, configXML);
