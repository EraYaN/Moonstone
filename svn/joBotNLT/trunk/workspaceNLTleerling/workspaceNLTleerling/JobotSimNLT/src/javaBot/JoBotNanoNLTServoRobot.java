...
public class JoBotNanoNLTServoRobot extends NanoRobot {
	...
	private static final String	CONFIG_XML			= Simulator
															.getRelativePath("./Nano/Servo/joBotNano.xml");
	 ...
	 */
	public JoBotNanoNLTServoRobot(String name, double positionX, double positionY)
	{
		/*
		 * friction = 7.0
		 * diameter = 2.0
