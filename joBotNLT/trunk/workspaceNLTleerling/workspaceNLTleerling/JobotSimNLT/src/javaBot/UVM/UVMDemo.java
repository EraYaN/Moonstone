...
public class UVMDemo extends UVMRunnable implements AgentWebService,
	...
	public static final int STATE_VOETBAL = 13;
	/**
...
//			currentBehavior = new IdleBehavior(joBot, behaviorServiceTick,	50);
		...
		case STATE_CALIBRATE:
			currentBehavior = new CalibrateServoBehavior(joBot, behaviorServiceTick, 100);
			break;
		case STATE_TEST:
		...
		case STATE_WALL_HUG:
			...
			break;
//		case STATE_VOETBAL:
//			currentBehavior = new VoetBalBehavior(joBot, behaviorServiceTick, 50);
//			break;
...
//	 		break;		
	...
	public void run() {
		...
		try {
			...
			joBot = new BaseController(getPeripheralFactory());
			joBot.setStatusLeds(false, false, false);
			drive(0, 0, 0);
