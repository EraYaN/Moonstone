 ...
 *         the JPB2Robot
 */
public class JPB2AVRRobot extends UVMRobot
{
	private static final String	IMAGE_FILE			= Simulator
															.getRelativePath("./resources/jobot.gif");
	private static final String	CONFIG_XML			= Simulator.getRelativePath("./JPB2/AVRCam/jobot.xml");
	 ...
	 * @param positionY
	 */
	public JPB2AVRRobot(String name, double positionX, double positionY)
	{
		/*
		 * friction = 7.0
		 * diameter = 2.0
		...
		try
		{
			...
			getSensors()[3] = addSensor("FieldSensor", BASE_RADIUS, 60);					// Left / Middle
			getSensors()[4] = addSensor("FieldSensor", BASE_RADIUS, 120);					// Right
			getSensors()[5] = addSensor("AVRSensor", BASE_RADIUS, 490, 270);				// Left
			getSensors()[6] = addSensor("AVRSensor", BASE_RADIUS, 410, 270);				// Right
		}
