...
public class JoBotNanoNLTGridRobot extends NanoRobot
{
	...
	private static final String	CONFIG_XML			= Simulator
															.getRelativePath("./Nano/Grid/joBotNano.xml");
	 ...
	 * @param positionY
	 */
	public JoBotNanoNLTGridRobot(String name, double positionX, double positionY)
	{
		/*
		 * friction = 7.0
		 * diameter = 2.0
