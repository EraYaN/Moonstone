...
// Required changes
// TODO: JoBot does not draw field sensors
// TODO: Orientation of Jobot must be made compatible with Junior
// TODO: When scaling JoBot in a field, ball lines are not drawn correctly
// TODO: When source code changes, simulator must be restarted or should reload
// TODO: Setting sensor position and angle is not consistent

// Working on: 
// TODO: Include EEPROM facility in openVBB interface
// TODO: OpenVBB no longer works with ToneGenerator
// TODO: Values from simulator are not same as from VBB
// TODO: Include calibration facilities
...
// TODO: MazeAgent does not work properly, when start to left not OK
...
/** 
 * Ver 0.0 - 08-06-2004 
 * Ver 0.1 - 03-07-2004 - Included dummy Jobot creation 
 * Ver 0.2 - 31-08-2004 - Updated DIP settings 
 * Ver 0.3 - 23-09-2004 - Cleaned up small problems: vector fix, setState, stop, 
 * 						  ball rolling included new unit tests 
 * Ver 0.4 - 30-12-2004 - Included IR ball sensor Corrected error in rotation direction 
 * Ver 0.5 - 17-02-2005 - Included updated Sharp sensor characteristics 
 * Ver 0.6 - 25-03-2007 - New JoBot sensor spec included
 */
 ...
 * times a second until the Simulator is paused or quitted. 
 */
...
public class Simulator extends JPanel
{
	...
	private static final String			WINDOW_TITLE					= "JoBotSim NLT Leerling V323";     //PY_COMMENT_ADD	
...
//		menuSimulation.add(new JMenuItem("JrSoccerDemo"));
...
//		menuSimulation.add(new JMenuItem("Dancing joBots"));
		menuSimulation.addSeparator();
		menuSimulation.add(new JMenuItem("Grid - Nano"));
		menuSimulation.add(new JMenuItem("Rescue - Nano"));
		menuSimulation.add(new JMenuItem("Toets - Nano"));
//		menuSimulation.add(new JMenuItem("Test - Nano"));        //PY_COMMENT_ADD
//		menuSimulation.add(new JMenuItem("Soccer - Nano"));      //PY_COMMENT_ADD   
//		menuSimulation.add(new JMenuItem("Servo - Nano"));       //PY_COMMENT_ADD
//		menuSimulation.add(new JMenuItem("Dance - Nano"));
//		menuSimulation.addSeparator();
//		menuSimulation.addSeparator();
//		menuSimulation.add(new JMenuItem("Grid - Junior"));      //PY_COMMENT_ADD
//		menuSimulation.add(new JMenuItem("Rescue - Junior"));    //PY_COMMENT_ADD
//		menuSimulation.add(new JMenuItem("Soccer - Junior"));    //PY_COMMENT_ADD
//		menuSimulation.add(new JMenuItem("Test - Junior"));      //PY_COMMENT_ADD
//		menuSimulation.addSeparator();                           //PY_COMMENT_ADD 
//		menuSimulation.add(new JMenuItem("Grid - Jobot"));       //PY_COMMENT_ADD
//		menuSimulation.add(new JMenuItem("Test - Jobot"));       //PY_COMMENT_ADD
//		menuSimulation.add(new JMenuItem("Rescue - Jobot"));     //PY_COMMENT_ADD 
//		menuSimulation.add(new JMenuItem("Soccer - Jobot"));     //PY_COMMENT_ADD
//		menuSimulation.add(new JMenuItem("AVRCam - Jobot"));     //PY_COMMENT_ADD
		menuSimulation.addSeparator();                           //PY_COMMENT_ADD    
//		menuSimulation.add(new JMenuItem("UVM - Jobot"));        //PY_COMMENT_ADD
...
//		menuCommands.add(showSoccerfield);
	...
	private JMenu getMenuInsert()
	{
		...
		submenuObject.add(new JMenuItem("Brick"));
		...
		submenuRobot.add(new JMenuItem("JoBot Jr"));
		submenuRobot.add(new JMenuItem("JoBot Nano"));
...
//		submenuRobot.add(new JMenuItem("MouseBot"));
	...
	private class SimulatorActionListener implements ActionListener, ChangeListener
	{
		...
		public void actionPerformed(ActionEvent e)
		{
			...
			if (e.getActionCommand().equals("Brick"))
			{
				Brick b = new Brick();
				b.name = "Brick";
			...
			{
				Robot r = new JPB2GridRobot("Jobot", World.WIDTH / 2, World.HEIGHT / 2);
				addRobotToGui(r);
			...
			{
				Robot r = new JPB2JrRescueRobot("Jobot Jr", World.WIDTH / 2, World.HEIGHT / 2);
				addRobotToGui(r);
			...
			if (e.getActionCommand().equals("JuniorDemo"))
			{
				...
				showLabels.setState(false);
				showSensorLines.setState(true);
				Robot r = new JPB2JrRobot("JuniorDemo", World.WIDTH / 2, World.HEIGHT / 2);
				RobotGUI robotGUI = new RobotGUI(r, getSimulator());
				world.addMovableObject(r);
				Ball b = new Ball();
				b.setLocation(new Location(World.WIDTH / 2, World.HEIGHT - 0.9));
				world.addMovableObject(b);
		...
		if (e.getActionCommand().equals("RescueDemo"))
			{
				...
				showLabels.setState(false);
				showSensorLines.setState(true);
				Robot r = new JPB2JrRobot("RescueDemo", World.WIDTH / 2, World.HEIGHT / 2);
				r.diameter=0.12;
				r.setLocation(new Location(r.diameter*0.9, r.diameter));
				r.rotation = 2 * Math.PI;
				Victim v = new Victim();
				world.addMovableObject(v);
				v.setLocation(new Location(0.4, World.HEIGHT - 0.4));
		...
		{
			clearMovableObjectsfromWorld();
			showRescuefield.setSelected(false);
			showSoccerfield.setSelected(false);
			showEmptyfield.setSelected(true);
			...
			if (e.getActionCommand().equals("JrSoccerDemo"))
				{
					clearMovableObjectsfromWorld();
					showSoccerfieldDbl.setSelected(true);
					Robot r = new JPB2JrSoccerRobot("JrSoccerDemo", World.WIDTH / 2, World.HEIGHT / 2);
					RobotGUI robotGUI = new RobotGUI(r, getSimulator());
					world.addMovableObject(r);
					Ball b = new Ball();
...
// NLT Lessen -------------------------------------------------------
			if (e.getActionCommand().equals("Grid - Junior"))
			{
				clearMovableObjectsfromWorld();
				showDancefloor.setSelected(false);
				showRescuefield.setSelected(false);
				showSoccerfield.setSelected(false);
				showEmptyfield.setSelected(true);
				Robot r = new JPB2JrNLTGridRobot("Grid", World.WIDTH / 2, World.HEIGHT / 2);
				r.setLocation(new Location((World.WIDTH / 2) - 0.4, World.HEIGHT / 2));
				r.rotation = 2 * Math.PI;
//				r.diameter=0.16;
				RobotGUI robotGUI = new RobotGUI(r, getSimulator());
				Vector guis = new Vector(2);
			...
			if (e.getActionCommand().equals("Grid - Nano"))
			{
				clearMovableObjectsfromWorld();
				showDancefloor.setSelected(false);
				showRescuefield.setSelected(false);
				showSoccerfield.setSelected(false);
				showEmptyfield.setSelected(true);
				Robot r = new JoBotNanoNLTGridRobot("Grid", World.WIDTH / 2, World.HEIGHT / 2);
				r.setLocation(new Location((World.WIDTH / 2) - 0.4, World.HEIGHT / 2));
				r.rotation = 2 * Math.PI;
//				r.diameter=0.18;
				RobotGUI robotGUI = new RobotGUI(r, getSimulator());
			...
			if (e.getActionCommand().equals("Rescue - Junior"))
			{
				clearMovableObjectsfromWorld();
				showDancefloor.setSelected(false);
				showRescuefield.setSelected(true);
				Robot r = new JPB2JrNLTRescueRobot("Rescue", World.WIDTH / 2, World.HEIGHT / 2);
//				r.diameter=0.16;
				r.setLocation(new Location(World.WIDTH / 8, World.HEIGHT / 4));
				r.rotation = 2 * Math.PI;
				RobotGUI robotGUI = new RobotGUI(r, getSimulator());
				Vector guis = new Vector(2);
				guis.add(robotGUI);
			...
			if (e.getActionCommand().equals("Rescue - Nano"))
			{
				clearMovableObjectsfromWorld();
				showDancefloor.setSelected(false);
				showRescuefield.setSelected(true);
				Robot r = new JoBotNanoNLTRescueRobot("Rescue", World.WIDTH / 2, World.HEIGHT / 2);
//				r.diameter=0.16;
				r.setLocation(new Location(World.WIDTH / 8, World.HEIGHT / 4));
				r.rotation = 2 * Math.PI;
				RobotGUI robotGUI = new RobotGUI(r, getSimulator());
			...
			if (e.getActionCommand().equals("Soccer - Junior"))
			{
				clearMovableObjectsfromWorld();
				showDancefloor.setSelected(false);
				showSoccerfieldDbl.setSelected(true);
				Robot r = new JPB2JrNLTSoccerRobot("Soccer", 0.15, World.HEIGHT / 2);
//				r.diameter=0.16;
				r.rotation = 0.5 * Math.PI;
				Ball b = new Ball();
				b.setLocation(new Location(0.0, World.HEIGHT));
			...
			if (e.getActionCommand().equals("Soccer - Nano"))
			{
				clearMovableObjectsfromWorld();
				showDancefloor.setSelected(false);
				showRescuefield.setSelected(false);
				showSoccerfieldDbl.setSelected(true);
				Robot r = new JoBotNanoNLTSoccerRobot("Soccer", 0.15, World.HEIGHT / 2);
//				r.diameter=0.16;
				r.rotation = 0.5 * Math.PI;
				Ball b = new Ball();
				b.setLocation(new Location(0.0, World.HEIGHT));
			...
			if (e.getActionCommand().equals("Test - Nano"))
			{
				clearMovableObjectsfromWorld();
				showDancefloor.setSelected(false);
				showRescuefield.setSelected(true);
				Robot r = new JoBotNanoNLTTestRobot("Test", World.WIDTH / 2, World.HEIGHT / 2);
//				r.diameter=0.14;
				r.setLocation(new Location(r.diameter*0.9, r.diameter));
				r.rotation = 2 * Math.PI;
				RobotGUI robotGUI = new RobotGUI(r, getSimulator());
			...
			if (e.getActionCommand().equals("Toets - Nano"))
			{
				clearMovableObjectsfromWorld();
				showDancefloor.setSelected(false);
				showRescuefield.setSelected(true);
				Robot r = new JoBotNanoNLTToetsRobot("Toets", World.WIDTH / 2, World.HEIGHT / 2);
//				r.diameter=0.16;
				r.setLocation(new Location(World.WIDTH / 8, World.HEIGHT / 4));
				r.rotation = 2 * Math.PI;
				RobotGUI robotGUI = new RobotGUI(r, getSimulator());
			...
			if (e.getActionCommand().equals("Servo - Nano"))
			{
				clearMovableObjectsfromWorld();
				showDancefloor.setSelected(false);
				showRescuefield.setSelected(true);
				Robot r = new JoBotNanoNLTServoRobot("Servo", World.WIDTH / 2, World.HEIGHT / 2);
//				r.diameter=0.14;
				r.setLocation(new Location(r.diameter*0.9, r.diameter));
				r.rotation = 2 * Math.PI;
				RobotGUI robotGUI = new RobotGUI(r, getSimulator());
			...
			if (e.getActionCommand().equals("Test - Junior"))
			{
				clearMovableObjectsfromWorld();
				showDancefloor.setSelected(false);
				showRescuefield.setSelected(true);
				Robot r = new JPB2JrNLTTestRobot("Test", World.WIDTH / 2, World.HEIGHT / 2);
//				r.diameter=0.14;
				r.setLocation(new Location(r.diameter*0.9, r.diameter));
				r.rotation = 2 * Math.PI;
				RobotGUI robotGUI = new RobotGUI(r, getSimulator());
			...
			if (e.getActionCommand().equals("Grid - Jobot"))
			{
				clearMovableObjectsfromWorld();
				showRescuefield.setSelected(false);
				showDancefloor.setSelected(false);
				Robot r = new JPB2GridRobot("JPB2Grid", World.WIDTH / 2, World.HEIGHT / 2);
//				r.diameter=0.09;
//				r.setLocation(new Location(r.diameter, r.diameter));
				r.rotation = 2 * Math.PI;
...
//				robotGUI.setDipSwitch(0);
			...
			if (e.getActionCommand().equals("Test - Jobot"))
			{
				clearMovableObjectsfromWorld();
				showRescuefield.setSelected(false);
				showDancefloor.setSelected(false);
				Robot r = new JPB2TestRobot("TestJoBot", World.WIDTH / 2, World.HEIGHT / 2);
				r.rotation = 2 * Math.PI;
				RobotGUI robotGUI = new RobotGUI(r, getSimulator());
				Vector guis = new Vector(2);
				guis.add(robotGUI);
			...
			if (e.getActionCommand().equals("Rescue - Jobot"))
			{
				clearMovableObjectsfromWorld();
				showRescuefield.setSelected(true);
				Robot r = new JPB2RescueRobot("RescueDemo", World.WIDTH / 2, World.HEIGHT / 2);
				r.diameter=0.09;
				r.setLocation(new Location(r.diameter*0.9, r.diameter));
				r.rotation = 2 * Math.PI;
				Victim v = new Victim();
...
//				robotGUI.setDipSwitch(2);
			...
			if (e.getActionCommand().equals("Soccer - Jobot"))
			{
				clearMovableObjectsfromWorld();
				showSoccerfieldDbl.setSelected(true);
				Robot r = new JPBSoccerRobot("SoccerDemo", 0.15, World.HEIGHT / 2);
			...
			if (e.getActionCommand().equals("AVRCam - Jobot"))
			{
				clearMovableObjectsfromWorld();
				showSoccerfieldDbl.setSelected(true);
				Robot r = new JPB2AVRRobot("AVRDemo", World.WIDTH / 2 + 0.3, World.HEIGHT / 2);
//				r.diameter=0.09;
				r.rotation = 1.5 * Math.PI;
				Ball b = new Ball();
//				b.diameter = 0.04;
			...
			if (e.getActionCommand().equals("UVM - Jobot"))
			{
			...
			if (e.getActionCommand().equals("JoBot"))
			{
				Robot r = new JPB2GridRobot("JoBotDemo", World.WIDTH / 2, World.HEIGHT / 2);
				addRobotToGui(r);

				return;
			}

			if (e.getActionCommand().equals("JoBot Jr"))
			{
				Robot r = new JPB2JrRobot("JuniorDemo", World.WIDTH / 2, World.HEIGHT / 2);
				addRobotToGui(r);
			...
			if (e.getActionCommand().equals("JoBot Nano"))
			{
				Robot r = new JoBotNanoNLTTestRobot("NanoDemo", World.WIDTH / 2, World.HEIGHT / 2);
				addRobotToGui(r);
