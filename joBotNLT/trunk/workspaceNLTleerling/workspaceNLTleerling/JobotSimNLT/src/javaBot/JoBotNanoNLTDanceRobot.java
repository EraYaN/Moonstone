...
public class JoBotNanoNLTDanceRobot extends NanoRobot
{
	...
	private static final String	CONFIG_XML			= Simulator
															.getRelativePath("./Nano/Dance/joBotNano.xml");
	 ...
	 * @param positionY
	 */
	public JoBotNanoNLTDanceRobot(String name, double positionX, double positionY)
	{
		/*
		 * friction = 7.0
		 * diameter = 2.0
